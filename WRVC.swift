...
class WRVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if (segue.identifier == "wrsToRbs") {
            var rbCont: RBVC = segue.destinationViewController
                as! RBVC
        ...
        else if (segue.identifier == "wrsToTes") {
            var teCont: TEVC = segue.destinationViewController
                as! TEVC
