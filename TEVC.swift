...
class TEVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        else if (segue.identifier == "tesToDefs") {
            var defCont: DEFVC = segue.destinationViewController
                as! DEFVC
